...
function ApplicationDetailView({ application }: { application: InternshipDetail }) {
  ...
  const needsClarification = application.status === "changes_requested";
...
export default async function ApplicationDetailPage(
  ...
  let application;
  try {
    application = await getMyInternship(id);
  } catch (error) {
