...
export default function RealityCardError({
  retry,
}: {
    ...
    <div className={cn(exploreFont.className, exploreDisplay.variable, STUDENT_PAGE_CANVAS)}>
      <div className={APP_CONTAINER}>
        <section
          ...
          aria-labelledby="reality-card-error-heading"
        >
          <h1 id="reality-card-error-heading" className={cn(DISPLAY_SECTION, "text-xl sm:text-2xl")}>
            Reality Card could not load
          </h1>
          <p className={cn("mt-2 text-sm leading-relaxed", MUTED)}>
            We could not load this verified experience right now. Please try again, or return to
            Explore.
          </p>
