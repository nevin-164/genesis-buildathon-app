...
import { respondToVerificationAction } from "@/app/(app)/student/internships/actions";
import {
  INK,
  MUTED,
  MUTED_LIGHT,
...
export function ChangesRequestedBox({
  internshipId,
  facultyMessage,
  ...
  const [state, formAction] = useActionState(respondToVerificationAction, initialActionState);
  ...
  return (
    ...
    >
      ...
      <p className={cn("mt-1 text-sm", MUTED)}>
        Answer what your advisor asked so your internship can be reviewed again.
      </p>
